    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">Advanced campaign analysis and ROI tracking.</p>
        </div>
        <div className="mt-4 flex space-x-3 sm:mt-0">
          <div className="relative">
            ...
            <input
              ...
              className="rounded-md border border-white/10 bg-white/5 py-2 pl-9 pr-4 text-sm text-white focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary w-64"
              value={searchTerm}
      ...
      <div className="grid gap-6 sm:grid-cols-3">
        <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-md bg-gradient-to-br from-green-500/10 to-transparent">
          <div className="flex items-center gap-3 mb-2">
            <TrendingUp className="h-5 w-5 text-green-400" />
            <h3 className="font-semibold text-white">Top Performer</h3>
          </div>
          <p className="text-sm text-slate-400">Retargeting Cart Abandoners</p>
          <div className="mt-4 flex justify-between items-end">
            <div>
              <p className="text-xs text-slate-500">ROAS</p>
              <p className="text-2xl font-bold text-green-400">7.6x</p>
            </div>
            <button className="text-xs text-primary hover:underline">View insights</button>
          </div>
        </div>

        <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-md bg-gradient-to-br from-red-500/10 to-transparent">
          <div className="flex items-center gap-3 mb-2">
            <TrendingDown className="h-5 w-5 text-red-400" />
            <h3 className="font-semibold text-white">Critical Anomaly</h3>
          </div>
          <p className="text-sm text-slate-400">Q3 Meta Ads Display 142</p>
          <div className="mt-4 flex justify-between items-end">
            <div>
              <p className="text-xs text-slate-500">Spend vs Conversions</p>
              <p className="text-2xl font-bold text-red-400">$45.2k / 0</p>
            </div>
            <button className="text-xs text-red-400 hover:underline">Investigate</button>
          </div>
        </div>

        <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-md relative overflow-hidden">
          <div className="flex items-center gap-3 mb-2">
          ...
          <p className="text-sm text-slate-300 mt-2">
            Shift $5,000 budget from <span className="font-medium text-white">Brand Awareness TikTok</span> to <span className="font-medium text-white">Summer Promo Search</span> to increase projected revenue by $12,400.
          </p>
                ...
                <tr key={c.id} className="hover:bg-white/5 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className={`font-bold ${
                      parseFloat(c.roas) > 3 ? 'text-green-400' : parseFloat(c.roas) < 1.5 ? 'text-red-400' : 'text-yellow-400'
                    }`}>
                      {c.roas}
                    </span>
                  </td>
